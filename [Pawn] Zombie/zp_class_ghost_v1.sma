...
const zclass_health = 1400	// Nastavenie éivota Zombie	| Default: 2500
const zclass_speed = 220		// Nastavenie R˝chlosti Zombie	| Default: 260

const Float:zclass_gravity = 1.0		// Nastavenie Gravit·ciÌ Zombie	| Default: 1.0/800
const Float:zclass_knockback = 0.5	// Nastavenie Odhodenia Zombie	| Default: 0.5

new const SOUND_INVIS[ ] = "profun/zombie/invisup.wav" ;	// Sound, ktor˝ sa prehr· pri spustenÌ schopnosti.
new const SOUND_INVIS_END[ ] = "profun/zombie/invisdown.wav";	// Sound, ktor˝ sa prehr· po skonËen˝ schopnosti.

const TIME_INVIS = 10;	// Trvanie schopnosti.	| Default: 15 sek˙nd
const TIME_COOLD = 30;	// NaËÌtavanie schopnosti.	| Default: 30 sek˙nd
