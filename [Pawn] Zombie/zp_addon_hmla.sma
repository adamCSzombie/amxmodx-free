...
#define PLUGIN			"[ZP-Addon] Hmla"
#define VERSION			"0.3"
#define	AUTHOR			"adamCSzombie"
#define FOG_DENSITY		"2"
#define FOG_R			"120"
#define FOG_G			"14"
#define FOG_B			"14"
...
public plugin_init( )
{
	...
	cvar_fog_density = 	register_cvar( "av_adv_fog_densityn", FOG_DENSITY );
	cvar_fog_color[ 0 ] = 	register_cvar( "zpd_adv_fog_color_Rnnnn", FOG_R  );
	cvar_fog_color[ 1 ] =	register_cvar( "zpd_adv_fog_color_Gnnnn", FOG_G );
	cvar_fog_color[ 2 ] = 	register_cvar( "zpd_adv_fog_color_Bnnnn", FOG_B );
