...
// Grenade cost
#define GRENADE_COST	3

// Grenade models
new const grenade_model_p [ ] = "models/usp_avatar/p_grenade_conc.mdl"
new const grenade_model [ ] = "models/usp_avatar/v_halu.mdl"
new const grenade_model_w [ ] = "models/usp_avatar/w_grenade_conc.mdl"
...
public plugin_init ( )
{
	...
	// New extra item
	new text[ 555 char ];
	formatex( text, charsmax( text ), "%L", LANG_PLAYER, "CONF_NAZOV" );
	g_conc = zp_register_extra_item ( text, GRENADE_COST, ZP_TEAM_ZOMBIE )
...
{
	register_native( "give_halu","native_give_halu",1 )
}

public native_give_halu( Player )
{
