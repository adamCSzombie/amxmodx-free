...
new const PLUGIN[ ] = "[ZP-Extra] Minigun"
new const VERSION[ ] = "1.4"
new const AUTHOR[ ] = "adamCSzombie"
...
new P_MODEL[ ] = "models/bluezone/zombie/p_minigun.mdl";
new V_MODEL[ ] = "models/bluezone/zombie/v_minigun.mdl";
new W_MODEL[ ] = "models/bluezone/zombie/w_minigun.mdl";

new m_SOUND[ ][ ] = { "bluezone/zombie/hw_shoot1.wav", "bluezone/zombie/hw_spin.wav", "bluezone/zombie/hw_spinup.wav", "bluezone/zombie/hw_spindown.wav" };
...
public plugin_init( ) 
{
	...
	clipstart = register_cvar( "amx_ammo_m249","10000" );
	clipstartsuv = register_cvar( "amx_ammosuv_m249","100000000000000000000000000" );
	m249 = register_cvar( "amx_minigun_speed","0.7" );
	DMGMG =	register_cvar( "amx_minigun_damaged","1.0" );
...
{
	register_native( "get_minigun", "give_minigun", 1 );
	register_native("have_user_minigun","native_is_user_hannibal",1)
}

public give_minigun( id, ammo, frst )
{
	has_minigun[ id ] = true;
...
public fw_PlayerKilled( victim, attacker, shouldgib )
{
	...
	if( has_minigun[ attacker ] && g_iCurrentWeapon[ attacker ] == CSW_M249 && !zp_get_user_nemesis( victim ) )
...
public zp_extra_item_selected( id, itemid )
{
	...
	{
		/*if( have_user_salamander( id ) )
		{
			client_print( id, print_center,"Ked mas kupeny plamenomet nemozes kupit MiniGun!" )
			zp_set_user_ammo_packs( id, zp_get_user_ammo_packs( id ) + 160 )
			return;
		}*/
		give_weapon( id,0,1 );
	}
...
public give_weapon( id, ammo, frst )
{
	...
	{
		client_print(id, print_center,"Ked si Hannibal nemozes kupit Minigun!")
...
public ammo_hud( id ) 
{
	if( !delayhud[ id ] ) 
	{
		...
		new AmmoHud[ 65 ];
		new clip = clipp[ id ];
		format( AmmoHud, 64, "Naboje do Minigunu: %i", clip );
...
public event_CurWeapon( id )
{
	...
	if(!has_minigun[ id ] || g_iCurrentWeapon[ id ] != CSW_M249 ) 
		return PLUGIN_CONTINUE
